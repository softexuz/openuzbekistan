...
<div id="wrapper">
    	<div id="main" class="transition">
					...
					<div id="indicWrap">
						<ul>
							<li id="unemployment" class="indicBtn" data-link="unemployment" onclick="alert('Ishsizlik!')">
								<div class="indicImg transition">
									<img src="img/indicator/unemployment.png">
								</div>
								<div class="indicName"><span>Ishsizlik darajasi</span></div>
							</li>
							<li id="inflation" class="indicBtn" data-link="inflation">
								<div class="indicImg transition">
									<img src="img/indicator/inflation.png">
								</div>
								<div class="indicName"><span>Inflatsiya</span></div>
							</li>
